...
def parse_args():
    ...
    parser.add_argument("--dataset", type=str, default="TanimotoSTM_aug", 
                        choices=["PubChemSTM", "PubChemSTM_SMILES", "PubChemSTM1K", "PubChemSTM10K", "PubChemSTM100K", "TanimotoSTM", "TanimotoSTM_aug", "TanimotoSTM_aug2", 
                                 "TanimotoSTM_aug3", "TanimotoSTM_aug4", "TanimotoSTM_aug3_1K", "TanimotoSTM_aug3_10K", "TanimotoSTM_aug3_100K",
                                 "TanimotoSTM_Wiki_aug", "TanimotoSTM_Wiki_verb", "PubChem10M"])
    ...
    if 'aug' in parser.parse_known_args()[0].model:
        parser.add_argument("--std", type=float, default=0.1)
    
    if 'Wiki' in parser.parse_known_args()[0].model:
        parser.add_argument("--alpha", type=float, default=1.0)

    if 'aug' in parser.parse_known_args()[0].dataset:
        parser.add_argument("--p_aug", type=float, default=0.0)
        parser.add_argument("--num_cand", type=int, default=30)
    
    if 'kd' in parser.parse_known_args()[0].model:
        parser.add_argument("--alpha", type=float, default=1.0)
    
    if 'vae' in parser.parse_known_args()[0].model:
        parser.add_argument("--beta", type=float, default=1.0)
    
    if 'verb' in parser.parse_known_args()[0].dataset:
        parser.add_argument("--p_aug", type=float, default=0.0)
        parser.add_argument("--num_cand", type=int, default=30)
