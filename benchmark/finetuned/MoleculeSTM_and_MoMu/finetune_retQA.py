...
from datasets import QA_retrieval
...
def get_loss(batch):
    ...
    train_loss = do_CL(molecule_repr, text_repr, label.to(device))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_model_config", type=str, default="MoleculeSTM.pth")
    ...
    dataset = QA_retrieval(args.dataspace_path)
    ...
    SAVE_PATH = "preds_retQA_finetune/"
